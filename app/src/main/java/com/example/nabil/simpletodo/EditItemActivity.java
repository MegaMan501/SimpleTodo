...
import static com.example.nabil.simpletodo.MainActivity.ITEM_POSITION;
import static com.example.nabil.simpletodo.MainActivity.ITEM_TEXT;

public class EditItemActivity extends AppCompatActivity {

    // track the edit text
    EditText etItemText;
    // position of editied text in list
    int position;
